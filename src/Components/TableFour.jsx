...
const TableFour = () => {
  ...
  return (
    <div>
      <div className="antialiased bg-gray-100 text-gray-600 pb-20  px-4">
                ...
                <table className="table-auto w-full">
                  <thead className="text-xs font-semibold uppercase text-black bg-gray-50">
                    <tr className="">
                      ...
                      <th className="p-2 whitespace-nowrap">
                        <div className="font-semibold text-left flex gap-2 items-center">
                          City <RiArrowUpDownFill></RiArrowUpDownFill>
                        </div>
                      </th>
                    ...
                    {datas?.map((data, i) => (
                      <tr key={data._id} className="">
                        ...
                        <td className="p-2 whitespace-nowrap">
                          <div className="text-left"> {data.city}</div>
                        </td>
        ...
        <div>
          <h1 className="text-xl font-bold  max-w-5xl">Download asset:</h1>
        </div>
      </div>
    </div>
  );
